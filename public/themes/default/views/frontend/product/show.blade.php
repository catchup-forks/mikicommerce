            ...
            <div class="product">
                <div class="clearfix">
                    <div class="left-col">
                        <div class="pic">
                            <a href="pic/catalog-product/item-1.jpg" rel="fancybox" class="fancybox">
                                <img src="{!! config('app.url').'/app/innovate/product/'.$product->img_big  !!}"
                                     width="400" height="490" alt="{!! $product->product_translations[0]->name !!}">
                    ...
                    <div class="right-col">
                        ...
                        <del>{!! $product->previous_price.' '.$product->currency !!}
                            ( {!! googleCurrency($product->currency,'USD',$product->previous_price) !!})
                        </del>
                        <div class="price">{!! $product->price.' '.$product->currency !!}
                            ( {!! googleCurrency($product->currency,'USD',$product->price) !!})
                        ...
                        <div class="quantity">
                            <p>Quantity:</p>
                            <a href="#" class="minus"></a><input name="quantity" type="number" value="1"><a href="#"
                                                                                                            class="plus"></a>
                        </div>
                        <a href="{!! route('frontend.cart.instance', ['id' =>$product->id] ) !!}"
                           class="button button-with-left-icon"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <div class="author">
                                        ...
                                        <a href="#">Cobus Bester</a> &nbsp; June 7, 2014
                                    </div>
                                    <p>Nulla lobortis facilisis eros vitae mollis. Morbi consectetur, tortor ut feugiat
                                        rhoncus, nunc augue placerat massa, sit amet laoreet est libero quis nisl.
                                        Integer cursus sodales sem eu dapibus. Morbi lobortis eleifend lectus sit amet
                                        porttitor. Nam tincidunt congue laoreet.</p>
                                </div>
                            </li>
                        ...
                        @foreach ($products as $product)
                            <li>
                                <div>
                                    <div class="pic">
                                        <img src="{!! config('app.url').'/app/innovate/product/'.$product->img_big !!}"
                                             alt="{!! $product->product_translations[0]->name !!}">
                                        <span></span>
                                        <ul>
                                            <li><a href="pic/catalog-grid/item-1.jpg" class="fa fa-plus fancybox"></a>
                                            </li>
                                    ...
                                    <h3>
                                        <a href="{!! route('product.show',$product->id) !!}">{!! $product->product_translations[0]->name !!}</a>
                                    </h3>
                                    ...
                                    <a href="{!! route('frontend.cart.instance', ['id' =>$product->id] ) !!}"
                                       class="button button-with-left-icon button-xsmall"><i
